...
public class TestShader3 implements Shader {
	...
	public void render(Renderable renderable) {
		...
		Color colorU = ((DoubleColorAttribute) renderable.material.get(DoubleColorAttribute.DiffuseUV)).color1;
		Color colorV = ((DoubleColorAttribute) renderable.material.get(DoubleColorAttribute.DiffuseUV)).color2;
